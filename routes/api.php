...
Route::get('users/{user}/dashboard', [UserController::class , 'getDashboard'])->name('users.dashboard')->middleware('auth:sanctum');
...
// STORE
Route::post('vehicles', [VehiculeController::class , 'store'])->name('vehicules.store')->middleware('auth:sanctum');
// RELATIONS
